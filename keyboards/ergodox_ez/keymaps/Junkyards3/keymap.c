...
[0] = LAYOUT_ergodox_pretty(
       KC_CAPS,    KC_1,    KC_2,         KC_3,           KC_4,          KC_5,  OSM(MOD_LCTL),      KC_EQL        , KC_6        , KC_7           , KC_8   , KC_9   , KC_0   , KC_LBRC,
        KC_TAB,    KC_Q,    KC_W,         KC_E,           KC_R,          KC_T,         KC_EQL,      KC_ENT        , KC_Y        , KC_U           , KC_I   , KC_O   , KC_P   , KC_RBRC,
LCTL_T(KC_ESC),    KC_A,    KC_S,         KC_D,           KC_F,          KC_G,                                      KC_H        , KC_J           , KC_K   , KC_L   , KC_SCLN, KC_QUOT,
 ...
 LSFT(KC_LCTL), KC_LGUI, KC_LALT, LSFT(KC_TAB),         KC_TAB,                                                                   KC_ENT         , KC_LALT, KC_RALT, KC_RGUI, OSM(MOD_LCTL|MOD_LALT)  ,
                                                                       ...
                                                                       KC_DEL,          TG(3),      OSM(MOD_HYPR) , OSM(MOD_MEH),
                                                                                      KC_PGDN,      KC_PGUP       ,
                                                LSFT_T(KC_SPC), LT(2,KC_PSLS), LCTL_T(KC_F13),      LSFT_T(KC_F14), LT(1,KC_DOT), LCTL_T(KC_BSPC)
),
