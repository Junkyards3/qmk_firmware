...
KC_LSFT,         KC_Z,         KC_X,         KC_C,         KC_V,         KC_B, RALT(KC_8),      CW_TOGG, KC_N         , KC_M         , KC_COMM     , KC_DOT      , KC_SLSH        , CW_TOGG ,
...
KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO, KC_TRNS,      KC_TRNS, KC_DEL , CW_TOGG, KC_CAPS, KC_WSCH, KC_NO  , KC_NO ,
