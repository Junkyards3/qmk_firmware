...
KC_NO, KC_LGUI, KC_LALT, KC_LSFT, KC_LCTL,   KC_NO,                        KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT, KC_UNDO, KC_NO ,
...
KC_TRNS, KC_EXLM,   KC_AT, KC_HASH,  KC_DLR, KC_PERC,   KC_NO,      KC_NO  , KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_NO ,
  ...
  KC_NO, KC_LGUI, KC_LALT, KC_LSFT, KC_LCTL,   KC_NO,                        KC_PEQL, KC_DLR , KC_PERC, KC_CIRC, KC_PAST, KC_NO ,
...
KC_NO, RALT(KC_3),    KC_RBRC,    RALT(KC_8),       KC_3,       KC_8,                        KC_NO  , KC_LCTL, KC_LSFT, KC_LALT, KC_LGUI, KC_NO ,
...
KC_NO, KC_NUBS, LSFT(KC_NUBS),       KC_5,       KC_MINS,   KC_NO,                        KC_NO  , KC_LCTL, KC_LSFT, KC_LALT, KC_LGUI, KC_NO ,
