...
LCTL_T(KC_ESC),    KC_A,    KC_S,         KC_D,           KC_F,            KC_G,                                     KC_H           , KC_J   , KC_K   , KC_L  , KC_SCLN, KC_QUOT,
 ...
 LSFT(KC_LCTL), KC_LGUI, KC_LALT, LSFT(KC_TAB),         KC_TAB,                                                                       KC_ENT , KC_LALT, KC_RALT, KC_RGUI, LSFT(KC_LCTL),

                                                                         KC_DEL,         TG(3),      OSM(MOD_HYPR), OSM(MOD_MEH) ,
                                                                                       KC_PGDN,      KC_PGUP       ,
                                                LSFT_T(KC_SPC),  LT(2,KC_LEFT), LCTL_T(KC_DOWN),     LSFT_T(KC_UP), LT(1,KC_RGHT)   , LCTL_T(KC_BSPC)
),
...
KC_TRNS, RALT(KC_2),    KC_LBRC, RALT(KC_5),   RALT(KC_MINS), LSFT(KC_DOT), KC_TRNS,      KC_TRNS, KC_QUOT   , KC_TRNS   , KC_TRNS      , KC_TRNS, KC_TRNS   , KC_TRNS,
